...
import com.soft1721.jianyue.mapper.UserMapper;
...
public class UserServiceImpl implements UserService {
    ...
    public int signUp(UserDTO userDTO) {
        ...
        if (user != null) {
            ...
            user1.setAvatar("http://smilesys.oss-cn-beijing.aliyuncs.com/avatar/default.png?Expires=1554292133&OSSAccessKeyId=TMP.AQHz8QArrtzxbb3VQMkjjdlwB2JvoOvmIMBh4CoHPerk718LdNehNeLBWDEcMC4CFQDgleDgj6q_VsjSB-9lTP7KcdjU1gIVAOnRS2ovGQSHNf9WpHc4nSLw0-OH&Signature=NT9%2BSOt7FX4VvmQnvt7B8XvKtmA%3D");
